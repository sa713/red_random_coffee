...
## Ready flow
- За `READY_WINDOW_HOURS` до ближайшего draw бот рассылает: «Я участвую ✅».
- Нажатие кнопки записывает readiness только для ближайшего раунда.
...
- `default`: предлагается ближайший рабочий день на 12:00 (timezone из `TIMEZONE`), длительность 30 минут.
...
- За `READY_WINDOW_HOURS` до жеребьёвки приходит сообщение с кнопкой «Я участвую ✅».
- Нажатие фиксирует готовность только для ближайшего раунда.
